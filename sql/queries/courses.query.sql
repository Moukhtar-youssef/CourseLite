...
-- name: GetAllCoursesPaginated :many
SELECT
    *
FROM
    courses
...
-- name: GetAllCoursesPaginatedByTitle :many
SELECT
    *
FROM
    courses
...
-- name: GetAllCoursesPaginatdByPrice :many
SELECT
    *
FROM
    courses
...
-- name: GetAllCoursesPaginatedByCreatedAt :many
SELECT
    *
FROM
    courses
...
INSERT INTO courses (creator_id, title, slug, description, price, currency, published)
...
INSERT INTO lessons (section_id, title, content, position)
    VALUES ($1, $2, $3, $4)
RETURNING
    *;
